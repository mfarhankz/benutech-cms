...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ContentWithSliderBlock".
 */
export interface ContentWithSliderBlock {
  heading?: {
    root: {
      type: string;
      children: {
  ...
  sliderType?: ('onlyText' | 'onlyImage' | 'both') | null;
  columns?:
    | {
        content?: {
          root: {
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        contentWithSlider?: T | ContentWithSliderBlockSelect<T>;
      };
  meta?:
    | T
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ContentWithSliderBlock_select".
 */
export interface ContentWithSliderBlockSelect<T extends boolean = true> {
  heading?: T;
  sliderType?: T;
  columns?:
    | T
