...
export const HighImpactHero: React.FC<Page['hero']> = ({ links, media, richText, columns }) => {
  ...
  return (
    <div
      className="relative -mt-[12.7rem] h-[100vh] flex items-center justify-center text-white"
      data-theme="dark"
    >
